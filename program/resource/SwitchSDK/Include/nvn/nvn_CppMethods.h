...
inline void Device::ApplyDeferredFinalizes(int age)
{
    pfncpp_nvnDeviceApplyDeferredFinalizes(this, age);
}
...
inline void CommandBuffer::BindUniformBuffers(ShaderStage stage, int first, int count, const BufferRange *buffers)
{
...
inline void CommandBuffer::BindTransformFeedbackBuffers(int first, int count, const BufferRange *buffers)
{
...
inline void CommandBuffer::BindStorageBuffers(ShaderStage stage, int first, int count, const BufferRange *buffers)
{
...
inline void CommandBuffer::BindTextures(ShaderStage stage, int first, int count, const TextureHandle *textures)
{
...
inline void CommandBuffer::BindImages(ShaderStage stage, int first, int count, const ImageHandle *images)
{
...
inline void CommandBuffer::SetInnerTessellationLevels(const float *levels)
{
    pfncpp_nvnCommandBufferSetInnerTessellationLevels(this, levels);
}

inline void CommandBuffer::SetOuterTessellationLevels(const float *levels)
{
...
inline void CommandBuffer::SetViewportSwizzles(int first, int count, const ViewportSwizzle *swizzles)
{
...
inline void CommandBuffer::BindSeparateTextures(ShaderStage stage, int first, int count, const SeparateTextureHandle *textureHandles)
{
    pfncpp_nvnCommandBufferBindSeparateTextures(this, stage, first, count, textureHandles);
}

inline void CommandBuffer::BindSeparateSamplers(ShaderStage stage, int first, int count, const SeparateSamplerHandle *samplerHandles)
{
...
inline void CommandBuffer::CopyBufferToTexture(BufferAddress src, const Texture *dstTexture, const TextureView *dstView, const CopyRegion *dstRegion, CopyFlags flags)
{
    pfncpp_nvnCommandBufferCopyBufferToTexture(this, src, dstTexture, dstView, dstRegion, flags);
}

inline void CommandBuffer::CopyTextureToBuffer(const Texture *srcTexture, const TextureView *srcView, const CopyRegion *srcRegion, BufferAddress dst, CopyFlags flags)
{
    pfncpp_nvnCommandBufferCopyTextureToBuffer(this, srcTexture, srcView, srcRegion, dst, flags);
}

inline void CommandBuffer::CopyTextureToTexture(const Texture *srcTexture, const TextureView *srcView, const CopyRegion *srcRegion, const Texture *dstTexture, const TextureView *dstView, const CopyRegion *dstRegion, CopyFlags flags)
{
...
inline void CommandBuffer::ClearTexture(const Texture *dstTexture, const TextureView *dstView, const CopyRegion *dstRegion, const float *color, ClearColorMask mask)
{
    pfncpp_nvnCommandBufferClearTexture(this, dstTexture, dstView, dstRegion, color, mask);
}

inline void CommandBuffer::ClearTexturei(const Texture *dstTexture, const TextureView *dstView, const CopyRegion *dstRegion, const int *color, ClearColorMask mask)
{
    pfncpp_nvnCommandBufferClearTexturei(this, dstTexture, dstView, dstRegion, color, mask);
}

inline void CommandBuffer::ClearTextureui(const Texture *dstTexture, const TextureView *dstView, const CopyRegion *dstRegion, const uint32_t *color, ClearColorMask mask)
{
    pfncpp_nvnCommandBufferClearTextureui(this, dstTexture, dstView, dstRegion, color, mask);
}

inline void CommandBuffer::UpdateUniformBuffer(BufferAddress buffer, size_t bufferSize, ptrdiff_t updateOffset, size_t updateSize, const void *data)
{
...
inline void CommandBuffer::SetRenderTargets(int numColors, const Texture * const *colors, const TextureView * const *colorViews, const Texture *depthStencil, const TextureView *depthStencilView)
{
...
inline void CommandBuffer::DownsampleTextureView(const Texture *src, const TextureView *srcView, const Texture *dst, const TextureView *dstView)
{
    pfncpp_nvnCommandBufferDownsampleTextureView(this, src, srcView, dst, dstView);
}

inline void CommandBuffer::TiledDownsampleTextureView(const Texture *src, const TextureView *srcView, const Texture *dst, const TextureView *dstView)
{
...
inline void CommandBuffer::DrawTexture(TextureHandle texture, const DrawTextureRegion *dstRegion, const DrawTextureRegion *srcRegion)
{
...
inline void CommandBuffer::SetProgramSubroutines(Program *program, ShaderStage stage, const int first, const int count, const int *values)
{
    pfncpp_nvnCommandBufferSetProgramSubroutines(this, program, stage, first, count, values);
}

inline void CommandBuffer::BindCoverageModulationTable(const float *entries)
{
...
inline void CommandBuffer::PushDebugGroupDynamic(uint32_t domainId, const char * description)
{
...
inline void CommandBuffer::InsertDebugMarkerDynamic(uint32_t domainId, const char * description)
{
