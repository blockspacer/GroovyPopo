...
#ifndef __nvn_cppfuncptrimpl_h_
#define __nvn_cppfuncptrimpl_h_
...
QueueBuilderSetQueuePriorityFunc pfncpp_nvnQueueBuilderSetQueuePriority;
QueueBuilderGetQueuePriorityFunc pfncpp_nvnQueueBuilderGetQueuePriority;
...
WindowBuilderSetNumActiveTexturesFunc pfncpp_nvnWindowBuilderSetNumActiveTextures;
...
WindowBuilderGetNumActiveTexturesFunc pfncpp_nvnWindowBuilderGetNumActiveTextures;
...
WindowSetNumActiveTexturesFunc pfncpp_nvnWindowSetNumActiveTextures;
WindowGetNumActiveTexturesFunc pfncpp_nvnWindowGetNumActiveTextures;
WindowGetNumTexturesFunc pfncpp_nvnWindowGetNumTextures;
...
ProgramSetShadersExtFunc pfncpp_nvnProgramSetShadersExt;
ProgramSetSampleShadingFunc pfncpp_nvnProgramSetSampleShading;
...
TextureBuilderGetRawStorageClassFunc pfncpp_nvnTextureBuilderGetRawStorageClass;
...
TextureGetRawStorageClassFunc pfncpp_nvnTextureGetRawStorageClass;
...
CommandBufferSetCommandMemoryCallbackEnabledFunc pfncpp_nvnCommandBufferSetCommandMemoryCallbackEnabled;
...
SyncInitializeFromFencedGLSyncFunc pfncpp_nvnSyncInitializeFromFencedGLSync;
SyncCreateGLSyncFunc pfncpp_nvnSyncCreateGLSync;
...
void nvnLoadCPPProcs(Device *device, DeviceGetProcAddressFunc getProc)
{
    ...
    pfncpp_nvnDeviceGetCurrentTimestampInNanoseconds = (DeviceGetCurrentTimestampInNanosecondsFunc)getProc(device, "nvnDeviceGetCurrentTimestampInNanoseconds");
    pfncpp_nvnDeviceSetIntermediateShaderCache = (DeviceSetIntermediateShaderCacheFunc)getProc(device, "nvnDeviceSetIntermediateShaderCache");
    ...
    pfncpp_nvnDeviceIsExternalDebuggerAttached = (DeviceIsExternalDebuggerAttachedFunc)getProc(device, "nvnDeviceIsExternalDebuggerAttached");
    ...
    pfncpp_nvnQueueBuilderSetCommandMemorySize = (QueueBuilderSetCommandMemorySizeFunc)getProc(device, "nvnQueueBuilderSetCommandMemorySize");
    pfncpp_nvnQueueBuilderSetComputeMemorySize = (QueueBuilderSetComputeMemorySizeFunc)getProc(device, "nvnQueueBuilderSetComputeMemorySize");
    pfncpp_nvnQueueBuilderSetControlMemorySize = (QueueBuilderSetControlMemorySizeFunc)getProc(device, "nvnQueueBuilderSetControlMemorySize");
    ...
    pfncpp_nvnQueueBuilderSetCommandFlushThreshold = (QueueBuilderSetCommandFlushThresholdFunc)getProc(device, "nvnQueueBuilderSetCommandFlushThreshold");
    pfncpp_nvnQueueBuilderSetQueuePriority = (QueueBuilderSetQueuePriorityFunc)getProc(device, "nvnQueueBuilderSetQueuePriority");
    pfncpp_nvnQueueBuilderGetQueuePriority = (QueueBuilderGetQueuePriorityFunc)getProc(device, "nvnQueueBuilderGetQueuePriority");
    ...
    pfncpp_nvnQueueBuilderGetCommandMemorySize = (QueueBuilderGetCommandMemorySizeFunc)getProc(device, "nvnQueueBuilderGetCommandMemorySize");
    pfncpp_nvnQueueBuilderGetComputeMemorySize = (QueueBuilderGetComputeMemorySizeFunc)getProc(device, "nvnQueueBuilderGetComputeMemorySize");
    pfncpp_nvnQueueBuilderGetControlMemorySize = (QueueBuilderGetControlMemorySizeFunc)getProc(device, "nvnQueueBuilderGetControlMemorySize");
    pfncpp_nvnQueueBuilderGetCommandFlushThreshold = (QueueBuilderGetCommandFlushThresholdFunc)getProc(device, "nvnQueueBuilderGetCommandFlushThreshold");
    ...
    pfncpp_nvnWindowBuilderSetNumActiveTextures = (WindowBuilderSetNumActiveTexturesFunc)getProc(device, "nvnWindowBuilderSetNumActiveTextures");
    ...
    pfncpp_nvnWindowBuilderGetNumActiveTextures = (WindowBuilderGetNumActiveTexturesFunc)getProc(device, "nvnWindowBuilderGetNumActiveTextures");
    ...
    pfncpp_nvnWindowSetNumActiveTextures = (WindowSetNumActiveTexturesFunc)getProc(device, "nvnWindowSetNumActiveTextures");
    pfncpp_nvnWindowGetNumActiveTextures = (WindowGetNumActiveTexturesFunc)getProc(device, "nvnWindowGetNumActiveTextures");
    pfncpp_nvnWindowGetNumTextures = (WindowGetNumTexturesFunc)getProc(device, "nvnWindowGetNumTextures");
    ...
    pfncpp_nvnProgramSetShadersExt = (ProgramSetShadersExtFunc)getProc(device, "nvnProgramSetShadersExt");
    pfncpp_nvnProgramSetSampleShading = (ProgramSetSampleShadingFunc)getProc(device, "nvnProgramSetSampleShading");
    ...
    pfncpp_nvnSamplerPoolRegisterSamplerBuilder = (SamplerPoolRegisterSamplerBuilderFunc)getProc(device, "nvnSamplerPoolRegisterSamplerBuilder");
    ...
    pfncpp_nvnTextureBuilderSetDepthStencilMode = (TextureBuilderSetDepthStencilModeFunc)getProc(device, "nvnTextureBuilderSetDepthStencilMode");
    pfncpp_nvnTextureBuilderGetStorageSize = (TextureBuilderGetStorageSizeFunc)getProc(device, "nvnTextureBuilderGetStorageSize");
    pfncpp_nvnTextureBuilderGetStorageAlignment = (TextureBuilderGetStorageAlignmentFunc)getProc(device, "nvnTextureBuilderGetStorageAlignment");
    pfncpp_nvnTextureBuilderSetStorage = (TextureBuilderSetStorageFunc)getProc(device, "nvnTextureBuilderSetStorage");
    pfncpp_nvnTextureBuilderSetPackagedTextureData = (TextureBuilderSetPackagedTextureDataFunc)getProc(device, "nvnTextureBuilderSetPackagedTextureData");
    pfncpp_nvnTextureBuilderSetPackagedTextureLayout = (TextureBuilderSetPackagedTextureLayoutFunc)getProc(device, "nvnTextureBuilderSetPackagedTextureLayout");
    ...
    pfncpp_nvnTextureBuilderGetDepthStencilMode = (TextureBuilderGetDepthStencilModeFunc)getProc(device, "nvnTextureBuilderGetDepthStencilMode");
    pfncpp_nvnTextureBuilderGetPackagedTextureData = (TextureBuilderGetPackagedTextureDataFunc)getProc(device, "nvnTextureBuilderGetPackagedTextureData");
    pfncpp_nvnTextureBuilderGetPackagedTextureLayout = (TextureBuilderGetPackagedTextureLayoutFunc)getProc(device, "nvnTextureBuilderGetPackagedTextureLayout");
    pfncpp_nvnTextureBuilderGetStride = (TextureBuilderGetStrideFunc)getProc(device, "nvnTextureBuilderGetStride");
    pfncpp_nvnTextureBuilderGetSparseTileLayout = (TextureBuilderGetSparseTileLayoutFunc)getProc(device, "nvnTextureBuilderGetSparseTileLayout");
    ...
    pfncpp_nvnTextureBuilderGetZCullStorageSize = (TextureBuilderGetZCullStorageSizeFunc)getProc(device, "nvnTextureBuilderGetZCullStorageSize");
    ...
    pfncpp_nvnTextureBuilderGetRawStorageClass = (TextureBuilderGetRawStorageClassFunc)getProc(device, "nvnTextureBuilderGetRawStorageClass");
    ...
    pfncpp_nvnTextureGetRawStorageClass = (TextureGetRawStorageClassFunc)getProc(device, "nvnTextureGetRawStorageClass");
    ...
    pfncpp_nvnSamplerBuilderSetReductionFilter = (SamplerBuilderSetReductionFilterFunc)getProc(device, "nvnSamplerBuilderSetReductionFilter");
    ...
    pfncpp_nvnSamplerBuilderGetReductionFilter = (SamplerBuilderGetReductionFilterFunc)getProc(device, "nvnSamplerBuilderGetReductionFilter");
    ...
    pfncpp_nvnBlendStateSetAdvancedPremultipliedSrc = (BlendStateSetAdvancedPremultipliedSrcFunc)getProc(device, "nvnBlendStateSetAdvancedPremultipliedSrc");
    pfncpp_nvnBlendStateSetAdvancedNormalizedDst = (BlendStateSetAdvancedNormalizedDstFunc)getProc(device, "nvnBlendStateSetAdvancedNormalizedDst");
    ...
    pfncpp_nvnBlendStateGetAdvancedPremultipliedSrc = (BlendStateGetAdvancedPremultipliedSrcFunc)getProc(device, "nvnBlendStateGetAdvancedPremultipliedSrc");
    pfncpp_nvnBlendStateGetAdvancedNormalizedDst = (BlendStateGetAdvancedNormalizedDstFunc)getProc(device, "nvnBlendStateGetAdvancedNormalizedDst");
    ...
    pfncpp_nvnMultisampleStateSetMultisampleEnable = (MultisampleStateSetMultisampleEnableFunc)getProc(device, "nvnMultisampleStateSetMultisampleEnable");
    pfncpp_nvnMultisampleStateSetSamples = (MultisampleStateSetSamplesFunc)getProc(device, "nvnMultisampleStateSetSamples");
    pfncpp_nvnMultisampleStateSetAlphaToCoverageEnable = (MultisampleStateSetAlphaToCoverageEnableFunc)getProc(device, "nvnMultisampleStateSetAlphaToCoverageEnable");
    pfncpp_nvnMultisampleStateSetAlphaToCoverageDither = (MultisampleStateSetAlphaToCoverageDitherFunc)getProc(device, "nvnMultisampleStateSetAlphaToCoverageDither");
    pfncpp_nvnMultisampleStateGetMultisampleEnable = (MultisampleStateGetMultisampleEnableFunc)getProc(device, "nvnMultisampleStateGetMultisampleEnable");
    pfncpp_nvnMultisampleStateGetSamples = (MultisampleStateGetSamplesFunc)getProc(device, "nvnMultisampleStateGetSamples");
    pfncpp_nvnMultisampleStateGetAlphaToCoverageEnable = (MultisampleStateGetAlphaToCoverageEnableFunc)getProc(device, "nvnMultisampleStateGetAlphaToCoverageEnable");
    pfncpp_nvnMultisampleStateGetAlphaToCoverageDither = (MultisampleStateGetAlphaToCoverageDitherFunc)getProc(device, "nvnMultisampleStateGetAlphaToCoverageDither");
    pfncpp_nvnMultisampleStateSetRasterSamples = (MultisampleStateSetRasterSamplesFunc)getProc(device, "nvnMultisampleStateSetRasterSamples");
    pfncpp_nvnMultisampleStateGetRasterSamples = (MultisampleStateGetRasterSamplesFunc)getProc(device, "nvnMultisampleStateGetRasterSamples");
    pfncpp_nvnMultisampleStateSetCoverageModulationMode = (MultisampleStateSetCoverageModulationModeFunc)getProc(device, "nvnMultisampleStateSetCoverageModulationMode");
    pfncpp_nvnMultisampleStateGetCoverageModulationMode = (MultisampleStateGetCoverageModulationModeFunc)getProc(device, "nvnMultisampleStateGetCoverageModulationMode");
    pfncpp_nvnMultisampleStateSetCoverageToColorEnable = (MultisampleStateSetCoverageToColorEnableFunc)getProc(device, "nvnMultisampleStateSetCoverageToColorEnable");
    pfncpp_nvnMultisampleStateGetCoverageToColorEnable = (MultisampleStateGetCoverageToColorEnableFunc)getProc(device, "nvnMultisampleStateGetCoverageToColorEnable");
    pfncpp_nvnMultisampleStateSetCoverageToColorOutput = (MultisampleStateSetCoverageToColorOutputFunc)getProc(device, "nvnMultisampleStateSetCoverageToColorOutput");
    pfncpp_nvnMultisampleStateGetCoverageToColorOutput = (MultisampleStateGetCoverageToColorOutputFunc)getProc(device, "nvnMultisampleStateGetCoverageToColorOutput");
    pfncpp_nvnMultisampleStateSetSampleLocationsEnable = (MultisampleStateSetSampleLocationsEnableFunc)getProc(device, "nvnMultisampleStateSetSampleLocationsEnable");
    pfncpp_nvnMultisampleStateGetSampleLocationsEnable = (MultisampleStateGetSampleLocationsEnableFunc)getProc(device, "nvnMultisampleStateGetSampleLocationsEnable");
    pfncpp_nvnMultisampleStateGetSampleLocationsGrid = (MultisampleStateGetSampleLocationsGridFunc)getProc(device, "nvnMultisampleStateGetSampleLocationsGrid");
    pfncpp_nvnMultisampleStateSetSampleLocationsGridEnable = (MultisampleStateSetSampleLocationsGridEnableFunc)getProc(device, "nvnMultisampleStateSetSampleLocationsGridEnable");
    pfncpp_nvnMultisampleStateGetSampleLocationsGridEnable = (MultisampleStateGetSampleLocationsGridEnableFunc)getProc(device, "nvnMultisampleStateGetSampleLocationsGridEnable");
    pfncpp_nvnMultisampleStateSetSampleLocations = (MultisampleStateSetSampleLocationsFunc)getProc(device, "nvnMultisampleStateSetSampleLocations");
    ...
    pfncpp_nvnPolygonStateSetPolygonOffsetEnables = (PolygonStateSetPolygonOffsetEnablesFunc)getProc(device, "nvnPolygonStateSetPolygonOffsetEnables");
    ...
    pfncpp_nvnPolygonStateGetPolygonOffsetEnables = (PolygonStateGetPolygonOffsetEnablesFunc)getProc(device, "nvnPolygonStateGetPolygonOffsetEnables");
    pfncpp_nvnDepthStencilStateSetDefaults = (DepthStencilStateSetDefaultsFunc)getProc(device, "nvnDepthStencilStateSetDefaults");
    pfncpp_nvnDepthStencilStateSetDepthTestEnable = (DepthStencilStateSetDepthTestEnableFunc)getProc(device, "nvnDepthStencilStateSetDepthTestEnable");
    pfncpp_nvnDepthStencilStateSetDepthWriteEnable = (DepthStencilStateSetDepthWriteEnableFunc)getProc(device, "nvnDepthStencilStateSetDepthWriteEnable");
    ...
    pfncpp_nvnDepthStencilStateSetStencilTestEnable = (DepthStencilStateSetStencilTestEnableFunc)getProc(device, "nvnDepthStencilStateSetStencilTestEnable");
    ...
    pfncpp_nvnDepthStencilStateGetDepthTestEnable = (DepthStencilStateGetDepthTestEnableFunc)getProc(device, "nvnDepthStencilStateGetDepthTestEnable");
    pfncpp_nvnDepthStencilStateGetDepthWriteEnable = (DepthStencilStateGetDepthWriteEnableFunc)getProc(device, "nvnDepthStencilStateGetDepthWriteEnable");
    ...
    pfncpp_nvnDepthStencilStateGetStencilTestEnable = (DepthStencilStateGetStencilTestEnableFunc)getProc(device, "nvnDepthStencilStateGetStencilTestEnable");
    ...
    pfncpp_nvnCommandBufferSetMemoryCallbackData = (CommandBufferSetMemoryCallbackDataFunc)getProc(device, "nvnCommandBufferSetMemoryCallbackData");
    pfncpp_nvnCommandBufferSetCommandMemoryCallbackEnabled = (CommandBufferSetCommandMemoryCallbackEnabledFunc)getProc(device, "nvnCommandBufferSetCommandMemoryCallbackEnabled");
    ...
    pfncpp_nvnCommandBufferGetCommandMemorySize = (CommandBufferGetCommandMemorySizeFunc)getProc(device, "nvnCommandBufferGetCommandMemorySize");
    pfncpp_nvnCommandBufferGetCommandMemoryUsed = (CommandBufferGetCommandMemoryUsedFunc)getProc(device, "nvnCommandBufferGetCommandMemoryUsed");
    pfncpp_nvnCommandBufferGetCommandMemoryFree = (CommandBufferGetCommandMemoryFreeFunc)getProc(device, "nvnCommandBufferGetCommandMemoryFree");
    pfncpp_nvnCommandBufferGetControlMemorySize = (CommandBufferGetControlMemorySizeFunc)getProc(device, "nvnCommandBufferGetControlMemorySize");
    pfncpp_nvnCommandBufferGetControlMemoryUsed = (CommandBufferGetControlMemoryUsedFunc)getProc(device, "nvnCommandBufferGetControlMemoryUsed");
    pfncpp_nvnCommandBufferGetControlMemoryFree = (CommandBufferGetControlMemoryFreeFunc)getProc(device, "nvnCommandBufferGetControlMemoryFree");
    ...
    pfncpp_nvnCommandBufferBindChannelMaskState = (CommandBufferBindChannelMaskStateFunc)getProc(device, "nvnCommandBufferBindChannelMaskState");
    pfncpp_nvnCommandBufferBindColorState = (CommandBufferBindColorStateFunc)getProc(device, "nvnCommandBufferBindColorState");
    pfncpp_nvnCommandBufferBindMultisampleState = (CommandBufferBindMultisampleStateFunc)getProc(device, "nvnCommandBufferBindMultisampleState");
    ...
    pfncpp_nvnCommandBufferBindDepthStencilState = (CommandBufferBindDepthStencilStateFunc)getProc(device, "nvnCommandBufferBindDepthStencilState");
    pfncpp_nvnCommandBufferBindVertexAttribState = (CommandBufferBindVertexAttribStateFunc)getProc(device, "nvnCommandBufferBindVertexAttribState");
    pfncpp_nvnCommandBufferBindVertexStreamState = (CommandBufferBindVertexStreamStateFunc)getProc(device, "nvnCommandBufferBindVertexStreamState");
    ...
    pfncpp_nvnCommandBufferBindTransformFeedbackBuffer = (CommandBufferBindTransformFeedbackBufferFunc)getProc(device, "nvnCommandBufferBindTransformFeedbackBuffer");
    pfncpp_nvnCommandBufferBindTransformFeedbackBuffers = (CommandBufferBindTransformFeedbackBuffersFunc)getProc(device, "nvnCommandBufferBindTransformFeedbackBuffers");
    ...
    pfncpp_nvnCommandBufferSetInnerTessellationLevels = (CommandBufferSetInnerTessellationLevelsFunc)getProc(device, "nvnCommandBufferSetInnerTessellationLevels");
    pfncpp_nvnCommandBufferSetOuterTessellationLevels = (CommandBufferSetOuterTessellationLevelsFunc)getProc(device, "nvnCommandBufferSetOuterTessellationLevels");
    pfncpp_nvnCommandBufferSetPrimitiveRestart = (CommandBufferSetPrimitiveRestartFunc)getProc(device, "nvnCommandBufferSetPrimitiveRestart");
    pfncpp_nvnCommandBufferBeginTransformFeedback = (CommandBufferBeginTransformFeedbackFunc)getProc(device, "nvnCommandBufferBeginTransformFeedback");
    pfncpp_nvnCommandBufferEndTransformFeedback = (CommandBufferEndTransformFeedbackFunc)getProc(device, "nvnCommandBufferEndTransformFeedback");
    pfncpp_nvnCommandBufferPauseTransformFeedback = (CommandBufferPauseTransformFeedbackFunc)getProc(device, "nvnCommandBufferPauseTransformFeedback");
    pfncpp_nvnCommandBufferResumeTransformFeedback = (CommandBufferResumeTransformFeedbackFunc)getProc(device, "nvnCommandBufferResumeTransformFeedback");
    pfncpp_nvnCommandBufferDrawTransformFeedback = (CommandBufferDrawTransformFeedbackFunc)getProc(device, "nvnCommandBufferDrawTransformFeedback");
    ...
    pfncpp_nvnCommandBufferDrawElementsBaseVertex = (CommandBufferDrawElementsBaseVertexFunc)getProc(device, "nvnCommandBufferDrawElementsBaseVertex");
    pfncpp_nvnCommandBufferDrawArraysInstanced = (CommandBufferDrawArraysInstancedFunc)getProc(device, "nvnCommandBufferDrawArraysInstanced");
    pfncpp_nvnCommandBufferDrawElementsInstanced = (CommandBufferDrawElementsInstancedFunc)getProc(device, "nvnCommandBufferDrawElementsInstanced");
    ...
    pfncpp_nvnCommandBufferDrawElementsIndirect = (CommandBufferDrawElementsIndirectFunc)getProc(device, "nvnCommandBufferDrawElementsIndirect");
    pfncpp_nvnCommandBufferMultiDrawArraysIndirectCount = (CommandBufferMultiDrawArraysIndirectCountFunc)getProc(device, "nvnCommandBufferMultiDrawArraysIndirectCount");
    pfncpp_nvnCommandBufferMultiDrawElementsIndirectCount = (CommandBufferMultiDrawElementsIndirectCountFunc)getProc(device, "nvnCommandBufferMultiDrawElementsIndirectCount");
    ...
    pfncpp_nvnCommandBufferDispatchComputeIndirect = (CommandBufferDispatchComputeIndirectFunc)getProc(device, "nvnCommandBufferDispatchComputeIndirect");
    ...
    pfncpp_nvnCommandBufferSetViewportSwizzles = (CommandBufferSetViewportSwizzlesFunc)getProc(device, "nvnCommandBufferSetViewportSwizzles");
    ...
    pfncpp_nvnCommandBufferSetTiledCacheAction = (CommandBufferSetTiledCacheActionFunc)getProc(device, "nvnCommandBufferSetTiledCacheAction");
    pfncpp_nvnCommandBufferSetTiledCacheTileSize = (CommandBufferSetTiledCacheTileSizeFunc)getProc(device, "nvnCommandBufferSetTiledCacheTileSize");
    pfncpp_nvnCommandBufferBindSeparateTexture = (CommandBufferBindSeparateTextureFunc)getProc(device, "nvnCommandBufferBindSeparateTexture");
    pfncpp_nvnCommandBufferBindSeparateSampler = (CommandBufferBindSeparateSamplerFunc)getProc(device, "nvnCommandBufferBindSeparateSampler");
    pfncpp_nvnCommandBufferBindSeparateTextures = (CommandBufferBindSeparateTexturesFunc)getProc(device, "nvnCommandBufferBindSeparateTextures");
    pfncpp_nvnCommandBufferBindSeparateSamplers = (CommandBufferBindSeparateSamplersFunc)getProc(device, "nvnCommandBufferBindSeparateSamplers");
    pfncpp_nvnCommandBufferSetStencilValueMask = (CommandBufferSetStencilValueMaskFunc)getProc(device, "nvnCommandBufferSetStencilValueMask");
    ...
    pfncpp_nvnCommandBufferSetPolygonOffsetClamp = (CommandBufferSetPolygonOffsetClampFunc)getProc(device, "nvnCommandBufferSetPolygonOffsetClamp");
    ...
    pfncpp_nvnCommandBufferSetRasterizerDiscard = (CommandBufferSetRasterizerDiscardFunc)getProc(device, "nvnCommandBufferSetRasterizerDiscard");
    pfncpp_nvnCommandBufferSetDepthClamp = (CommandBufferSetDepthClampFunc)getProc(device, "nvnCommandBufferSetDepthClamp");
    pfncpp_nvnCommandBufferSetConservativeRasterEnable = (CommandBufferSetConservativeRasterEnableFunc)getProc(device, "nvnCommandBufferSetConservativeRasterEnable");
    pfncpp_nvnCommandBufferSetConservativeRasterDilate = (CommandBufferSetConservativeRasterDilateFunc)getProc(device, "nvnCommandBufferSetConservativeRasterDilate");
    pfncpp_nvnCommandBufferSetSubpixelPrecisionBias = (CommandBufferSetSubpixelPrecisionBiasFunc)getProc(device, "nvnCommandBufferSetSubpixelPrecisionBias");
    pfncpp_nvnCommandBufferCopyBufferToTexture = (CommandBufferCopyBufferToTextureFunc)getProc(device, "nvnCommandBufferCopyBufferToTexture");
    pfncpp_nvnCommandBufferCopyTextureToBuffer = (CommandBufferCopyTextureToBufferFunc)getProc(device, "nvnCommandBufferCopyTextureToBuffer");
    pfncpp_nvnCommandBufferCopyTextureToTexture = (CommandBufferCopyTextureToTextureFunc)getProc(device, "nvnCommandBufferCopyTextureToTexture");
    ...
    pfncpp_nvnCommandBufferUpdateUniformBuffer = (CommandBufferUpdateUniformBufferFunc)getProc(device, "nvnCommandBufferUpdateUniformBuffer");
    ...
    pfncpp_nvnCommandBufferSetRenderEnableConditional = (CommandBufferSetRenderEnableConditionalFunc)getProc(device, "nvnCommandBufferSetRenderEnableConditional");
    ...
    pfncpp_nvnCommandBufferDiscardDepthStencil = (CommandBufferDiscardDepthStencilFunc)getProc(device, "nvnCommandBufferDiscardDepthStencil");
    ...
    pfncpp_nvnCommandBufferDownsampleTextureView = (CommandBufferDownsampleTextureViewFunc)getProc(device, "nvnCommandBufferDownsampleTextureView");
    pfncpp_nvnCommandBufferTiledDownsampleTextureView = (CommandBufferTiledDownsampleTextureViewFunc)getProc(device, "nvnCommandBufferTiledDownsampleTextureView");
    ...
    pfncpp_nvnCommandBufferSetShaderScratchMemory = (CommandBufferSetShaderScratchMemoryFunc)getProc(device, "nvnCommandBufferSetShaderScratchMemory");
    ...
    pfncpp_nvnCommandBufferSetProgramSubroutines = (CommandBufferSetProgramSubroutinesFunc)getProc(device, "nvnCommandBufferSetProgramSubroutines");
    pfncpp_nvnCommandBufferBindCoverageModulationTable = (CommandBufferBindCoverageModulationTableFunc)getProc(device, "nvnCommandBufferBindCoverageModulationTable");
    ...
    pfncpp_nvnCommandBufferSetColorReductionEnable = (CommandBufferSetColorReductionEnableFunc)getProc(device, "nvnCommandBufferSetColorReductionEnable");
    pfncpp_nvnCommandBufferSetColorReductionThresholds = (CommandBufferSetColorReductionThresholdsFunc)getProc(device, "nvnCommandBufferSetColorReductionThresholds");
    pfncpp_nvnCommandBufferPushDebugGroupStatic = (CommandBufferPushDebugGroupStaticFunc)getProc(device, "nvnCommandBufferPushDebugGroupStatic");
    pfncpp_nvnCommandBufferPushDebugGroupDynamic = (CommandBufferPushDebugGroupDynamicFunc)getProc(device, "nvnCommandBufferPushDebugGroupDynamic");
    ...
    pfncpp_nvnCommandBufferInsertDebugMarkerStatic = (CommandBufferInsertDebugMarkerStaticFunc)getProc(device, "nvnCommandBufferInsertDebugMarkerStatic");
    pfncpp_nvnCommandBufferInsertDebugMarkerDynamic = (CommandBufferInsertDebugMarkerDynamicFunc)getProc(device, "nvnCommandBufferInsertDebugMarkerDynamic");
    ...
    pfncpp_nvnCommandBufferGetMemoryCallbackData = (CommandBufferGetMemoryCallbackDataFunc)getProc(device, "nvnCommandBufferGetMemoryCallbackData");
    ...
    pfncpp_nvnSyncInitializeFromFencedGLSync = (SyncInitializeFromFencedGLSyncFunc)getProc(device, "nvnSyncInitializeFromFencedGLSync");
    pfncpp_nvnSyncCreateGLSync = (SyncCreateGLSyncFunc)getProc(device, "nvnSyncCreateGLSync");
    ...
    pfncpp_nvnCommandBufferSetStencilCullCriteria = (CommandBufferSetStencilCullCriteriaFunc)getProc(device, "nvnCommandBufferSetStencilCullCriteria");
} // nvnLoadCPPProcs
