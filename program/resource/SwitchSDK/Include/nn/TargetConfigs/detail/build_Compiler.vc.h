...
//#include <nn/TargetConfigs/build_Base.h>
    ...
    #error   "ツールチェイン種別として VC++ が指定されていません。"
#endif

#define NN_BUILD_CONFIG_COMPILER_VC               1
#define NN_BUILD_CONFIG_COMPILER_SUPPORTS_VC       1
...
#if defined(NN_BUILD_CONFIG_TOOLCHAIN_VC_VS2017)
    #define NN_BUILD_CONFIG_COMPILER_SUPPORTS_UNICODE_LITERALS 1
#elif defined(NN_BUILD_CONFIG_TOOLCHAIN_VC_VS2015)
    #define NN_BUILD_CONFIG_COMPILER_SUPPORTS_UNICODE_LITERALS 1
#elif defined(NN_BUILD_CONFIG_TOOLCHAIN_VC_VS2013) || defined(NN_BUILD_CONFIG_TOOLCHAIN_VC_VS2012)

#else
    #error   "NintendoSDK が対応していないバージョンの VC++ です。"
#endif
