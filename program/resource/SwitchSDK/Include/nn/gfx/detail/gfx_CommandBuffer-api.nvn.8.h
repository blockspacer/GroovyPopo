...
public:
    ...
    typedef void ( *OutOfMemoryEventCallback )(
        TCommandBuffer< ApiVariationNvn8 >* pCommandBuffer, const OutOfMemoryEventArg& arg );
    ...
    void SetVertexBuffer( int bufferIndex, const GpuAddress& vertexBufferAddress, ptrdiff_t stride, size_t size ) NN_NOEXCEPT;
    ...
    void SetRootConstantBuffer( PipelineType pipelineType, int indexDynamicDescriptor,
        const GpuAddress& bufferAddress, size_t size ) NN_NOEXCEPT;
