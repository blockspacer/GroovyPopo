...
class PauseSoundHandler :
    public viewer::detail::HioMessageHandlerImpl<viewer::detail::HioMessageType_PauseSound, PauseSoundPacket>
{
public:
    PauseSoundHandler() NN_NOEXCEPT : m_SoundObjectController(NULL) { }
    virtual ~PauseSoundHandler() NN_NOEXCEPT NN_OVERRIDE { }
