...
#if defined(CURL_PULL_SYS_TYPES_H) && !defined(NN_NINTENDO_SDK)
#  include <sys/types.h>
#endif

/* CURL_PULL_SYS_SOCKET_H is defined above when inclusion of header file  */
/* sys/socket.h is required here to properly make type definitions below. */
#if defined(CURL_PULL_SYS_SOCKET_H) && !defined(NN_NINTENDO_SDK)
#  include <sys/socket.h>
#endif

#if defined(NN_NINTENDO_SDK) && !defined(BUILDING_LIBCURL)
